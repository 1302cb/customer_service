 ...
 * @generated
 */
package com.cvte.customer_service.cuse.clause;
...
public class Data implements org.apache.thrift.TBase<Data, Data._Fields>, java.io.Serializable, Cloneable, Comparable<Data> {
    ...
    java.lang.String error; // optional
    public @org.apache.thrift.annotation.Nullable
    java.lang.String msg; // optional
    public @org.apache.thrift.annotation.Nullable
    java.lang.String id; // optional
    public @org.apache.thrift.annotation.Nullable
    java.lang.String chatbotID; // optional
    public @org.apache.thrift.annotation.Nullable
    java.util.List<Dict> customdicts; // optional
    public @Nullable
    java.util.List<Dict> sysdicts; // optional
    public @org.apache.thrift.annotation.Nullable
    java.util.List<BotSysdict> botsysdicts; // optional
    public @org.apache.thrift.annotation.Nullable
    java.util.List<DictWord> dictwords; // optional
    public @org.apache.thrift.annotation.Nullable
    Dict customdict; // optional
    public @org.apache.thrift.annotation.Nullable
    Dict sysdict; // optional
    public @org.apache.thrift.annotation.Nullable
    BotSysdict botsysdict; // optional
    public @org.apache.thrift.annotation.Nullable
    DictWord dictword; // optional
    public @org.apache.thrift.annotation.Nullable
    java.util.List<Intent> intents; // optional
    public @org.apache.thrift.annotation.Nullable
    java.util.List<IntentSlot> slots; // optional
    public @org.apache.thrift.annotation.Nullable
    java.util.List<IntentUtter> utters; // optional
    public @org.apache.thrift.annotation.Nullable
    Intent intent; // optional
    public @org.apache.thrift.annotation.Nullable
    IntentSlot slot; // optional
    public @org.apache.thrift.annotation.Nullable
    IntentUtter utter; // optional
    public @org.apache.thrift.annotation.Nullable
    java.util.List<DevelopVersion> devvers; // optional
    public @org.apache.thrift.annotation.Nullable
    java.util.List<ProdVersion> provers; // optional
    public @org.apache.thrift.annotation.Nullable
    DevelopVersion devver; // optional
    public @org.apache.thrift.annotation.Nullable
    ProdVersion prover; // optional
    public @org.apache.thrift.annotation.Nullable
    java.util.List<ChatSession> sessions; // optional
    public @org.apache.thrift.annotation.Nullable
    java.util.List<ChatMessage> messages; // optional
    public @org.apache.thrift.annotation.Nullable
    ChatSession session; // optional
    public @org.apache.thrift.annotation.Nullable
    ChatMessage message; // optional
